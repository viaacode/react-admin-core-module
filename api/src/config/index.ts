...
const config = (): Configuration => {
	...
	return {
		...
		databaseApplicationType: getEnvValue(
		...
		samlSpPrivateKey: cleanMultilineEnv(
			getEnvValue('SAML_SP_PRIVATE_KEY', false),
		),
		samlSpCertificate: cleanMultilineEnv(
			getEnvValue('SAML_SP_CERTIFICATE', false),
		),
		samlMeemooIdpMetaDataEndpoint: getEnvValue(
		...
		campaignMonitorApiEndpoint: getEnvValue(
