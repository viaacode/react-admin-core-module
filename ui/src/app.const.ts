			...
			subLinks: [
				{
					...
					location:
						AdminConfigManager.getAdminRoute('ADMIN_CONTENT_PAGE_OVERVIEW') + '/195',
					key: 'pages',
					exact: true,
				},
				{
					...
					location:
						AdminConfigManager.getAdminRoute('ADMIN_CONTENT_PAGE_OVERVIEW') + '/236',
					key: 'faqs',
					exact: true,
				},
				{
					...
					location:
						AdminConfigManager.getAdminRoute('ADMIN_CONTENT_PAGE_OVERVIEW') + '/313',
					key: 'faqs',
					exact: true,
				},
			],
