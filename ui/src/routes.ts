...
function getAdminRoutes(): RouteObject[] {
	...
	return [
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_OVERVIEW,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_CREATE,
		...
		},
		{
			...
			Component: ContentPageEditPage,
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_EDIT,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_DETAIL,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_LABEL_OVERVIEW,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_LABEL_CREATE,
		...
		},
		{
			...
			Component: ContentPageLabelsEditPage,
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_LABEL_EDIT,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_CONTENT_PAGE_LABEL_DETAIL,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_NAVIGATION_OVERVIEW,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_NAVIGATION_DETAIL,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_NAVIGATION_ITEM_CREATE,
		...
		},
		{
			...
			Component: NavigationItemEditPage,
			path: getAdminCoreConfig(noop).routes.ADMIN_NAVIGATION_ITEM_EDIT,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_TRANSLATIONS_OVERVIEW,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_USER_GROUP_OVERVIEW,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_USER_OVERVIEW,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_USER_DETAIL,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_USER_EDIT,
		...
		},
		{
			...
			path: getAdminCoreConfig(noop).routes.ADMIN_MAINTENANCE_ALERTS_OVERVIEW,
