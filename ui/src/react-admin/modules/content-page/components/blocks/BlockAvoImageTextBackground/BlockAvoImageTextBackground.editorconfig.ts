...
import { GET_COLOR_OPTIONS_EXTENDED_AVO } from '~modules/content-page/const/get-color-options.js';
import { GET_HEADING_SIZE_OPTIONS } from '~modules/content-page/const/get-heading-type-options.js';
...
import type {
	AvoImageTextBackgroundBlockComponentState,
	ContentBlockConfig,
	...
	components: {
		...
		fields: {
			...
			foregroundColor: {
				...
				editorProps: {
					options: GET_COLOR_OPTIONS_EXTENDED_AVO(),
					defaultValue: GET_COLOR_OPTIONS_EXTENDED_AVO()[0],
				},
			},
			backgroundColor: {
				label: tText(
