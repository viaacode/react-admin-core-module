...
export const KLAAR_BLOCK_CONFIG = (position = 0): ContentBlockConfig => ({
	...
	name: AdminConfigManager.getConfig().services.i18n.tText(
		'admin/content-block/helpers/generators/klaar___klaar', {}, [AVO]
	),
	type: ContentBlockType.Klaar,
	components: {
		name: AdminConfigManager.getConfig().services.i18n.tText(
			'admin/content-block/helpers/generators/klaar___klaar-titel', {}, [AVO]
		),
		limits: {
			max: 3,
		},
		...
		fields: {
			titles: TEXT_FIELD(
				AdminConfigManager.getConfig().services.i18n.tText(
					'admin/content-block/helpers/generators/klaar___titel-is-verplicht', {}, [AVO]
				),
				{
					label: AdminConfigManager.getConfig().services.i18n.tText(
						'admin/content-block/helpers/generators/klaar___titel', {}, [AVO]
					),
					editorType: ContentBlockEditor.TextInput,
					repeat: {
						defaultState: '',
						addButtonLabel: AdminConfigManager.getConfig().services.i18n.tText(
							'admin/content-block/helpers/generators/klaar___voeg-titel-toe', {}, [AVO]
						),
						deleteButtonLabel: AdminConfigManager.getConfig().services.i18n.tText(
							'admin/content-block/helpers/generators/klaar___verwijder-titel', {}, [AVO]
						),
					},
				}
			...
			date: {
				...
				validator: (value: string) => {
					...
					if (isNil(value) || isEmpty(value)) {
						errorArray.push(
							AdminConfigManager.getConfig().services.i18n.tText(
								'admin/content-block/helpers/generators/klaar___datum-is-verplicht', {}, [AVO]
							)
						);
					}
