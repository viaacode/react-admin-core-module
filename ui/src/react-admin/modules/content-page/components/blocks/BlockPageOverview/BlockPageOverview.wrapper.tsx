...
export const BlockPageOverviewWrapper: FunctionComponent<
...
> = ({
	...
	const { data: labelObjs, isFetching: isLoadingLabelObjs } =
		useGetContentPageLabelsByTypeAndIds(
			{
	...
	useEffect(() => {
		setQueryParamsState(
			{
				...queryParamsState,
				label: queryParamsState?.label?.length
					? queryParamsState.label
					: undefined,
			},
