...
export const BlockTitleImageText: FunctionComponent<
	BlockTitleImageTextProps
> = ({ className, title, imageSource, imageDescription = "", text = "" }) => {
	return (
		<Spacer className={className} margin="top-large">
			<Container size="small">
				{title && <h2 className="c-h2">{title}</h2>}
				{imageSource && (
					<Image src={imageSource} alt={imageDescription} wide={true} />
				)}
				{text && (
					<Spacer margin="top">
