...
import PublishContentPageModal from '~modules/content-page/components/PublishContentPageModal.js';
import { GET_CONTENT_PAGE_DETAIL_TABS } from '~modules/content-page/const/content-page.consts.js';
import { isPublic } from '~modules/content-page/helpers/get-published-state.js';
import { useSoftDeleteContentPage } from '~modules/content-page/hooks/useSoftDeleteContentPage.js';
...
import { ContentPageAction } from '~modules/content-page/types/content-pages.types.js';
import { ContentPageDetailMetaData } from '~modules/content-page/views/ContentPageDetailMetaData.js';
...
import MoreOptionsDropdown from '~shared/components/MoreOptionsDropdown/MoreOptionsDropdown.js';
...
import { buildLink, navigate, navigateToAbsoluteOrRelativeUrl } from '~shared/helpers/link.js';
