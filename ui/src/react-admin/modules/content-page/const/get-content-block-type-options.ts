...
export const GET_CONTENT_BLOCK_TYPE_OPTIONS: () => SelectOption<string>[] = () => {
	const allContentBlocks: { label: string; value: ContentBlockType }[] = [
		...
		{
			label: tText(
				'modules/content-page/const/get-content-block-type-options___afbeelding-met-h-1-avo',
				{},
				[AVO]
			),
		...
		{
			label: tText(
				'modules/content-page/const/get-content-block-type-options___driekeuzespeler',
				{},
				[HET_ARCHIEF]
			),
