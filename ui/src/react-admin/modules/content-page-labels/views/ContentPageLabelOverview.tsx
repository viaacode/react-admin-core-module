...
export const ContentPageLabelOverview: FunctionComponent<DefaultComponentProps> = ({
	...
	const generateWhereObject = useCallback((filters: Partial<ContentPageLabelTableState>) => {
		// biome-ignore lint/suspicious/noExplicitAny: todo
	...
	const getContentPageLabelOverviewTableCols: () => FilterableColumn<ContentPageLabelOverviewTableCols>[] =
		() => [
				...
				? [
						{
							...
							label: tText('modules/content-page-labels/views/content-page-label-overview___taal'),
							sortable: true,
							visibleByDefault: true,
							filterType: TableFilterType.CheckboxDropdownModal,
							filterProps: {
			...
			{
				id: 'created_at',
				label: tText('admin/content-page-labels/views/content-page-label-overview___gemaakt-op'),
				sortable: true,
				visibleByDefault: true,
			...
			{
				id: 'updated_at',
				label: tText('admin/content-page-labels/views/content-page-label-overview___aangepast-op'),
				sortable: true,
				visibleByDefault: true,
				filterType: TableFilterType.DateRangeDropdown,
				dataType: TableColumnDataType.dateTime,
	...
	const renderTableCell = (
		...
		switch (columnId) {
			case 'label':
				return (
					<Link
						to={buildLink(AdminConfigManager.getAdminRoute('ADMIN_CONTENT_PAGE_LABEL_DETAIL'), {
			...
			case 'created_at':
			case 'updated_at':
				return contentPageLabel[columnId] ? formatDate(contentPageLabel[columnId] as string) : '-';
