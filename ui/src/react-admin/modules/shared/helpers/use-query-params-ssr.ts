...
import type { QueryParamOptions } from 'use-query-params/src/options.ts';
...
export const useQueryParam = (
	...
	return useQueryParamLib
		? // biome-ignore lint/correctness/useHookAtTopLevel: this is a wrapper around the actual hook
...
export const StringParam = useQueryParamLib ? useQueryParamLib.StringParam : undefined;
export const NumberParam = useQueryParamLib ? useQueryParamLib.NumberParam : undefined;
export const ArrayParam = useQueryParamLib ? useQueryParamLib.ArrayParam : undefined;
export const BooleanParam = useQueryParamLib ? useQueryParamLib.BooleanParam : undefined;
export const DateParam = useQueryParamLib ? useQueryParamLib.DateParam : undefined;
export const JsonParam = useQueryParamLib ? useQueryParamLib.JsonParam : undefined;
export const DelimitedArrayParam = useQueryParamLib
	? useQueryParamLib.DelimitedArrayParam
	: undefined;
export const withDefault = useQueryParamLib ? useQueryParamLib.withDefault : (param: any) => param;
