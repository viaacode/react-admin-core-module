...
export function isSortDirection(value: string): value is Avo.Search.OrderDirection {
	return QUERY_PARAM_SORT_DIRECTIONS.includes(value as Avo.Search.OrderDirection);
}
