...
export const GET_CONTENT_TYPE_LABELS: () => Record<ContentPickerType, string> = () => ({
	[ContentPickerType.CONTENT_PAGE]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/content/content___content'
	),
	[ContentPickerType.INTERNAL_LINK]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/content/content___statisch'
	),
	[ContentPickerType.COLLECTION]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/content/content___collecties'
	),
	[ContentPickerType.ITEM]: AdminConfigManager.getConfig().services.i18n.t('admin/content/content___items'),
	[ContentPickerType.BUNDLE]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/content/content___bundels'
	),
	[ContentPickerType.EXTERNAL_LINK]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/shared/components/content-picker/content-picker___externe-url'
	),
	[ContentPickerType.SEARCH_QUERY]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/shared/components/content-picker/content-picker___zoekfilters'
	),
	[ContentPickerType.PROJECTS]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/shared/components/content-picker/content-picker___projecten'
	),
	[ContentPickerType.PROFILE]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/shared/components/content-picker/content-picker___gebruiker'
	),
	[ContentPickerType.ANCHOR_LINK]: AdminConfigManager.getConfig().services.i18n.t(
		'admin/shared/components/content-picker/content-picker___anchors'
	),
	[ContentPickerType.FILE]: AdminConfigManager.getConfig().services.i18n.t(
