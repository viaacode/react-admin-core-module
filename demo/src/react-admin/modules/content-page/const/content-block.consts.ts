...
export const GET_CONTENT_BLOCK_TYPE_OPTIONS: () => SelectOption<string>[] = () => {
	const allContentBlocks: { label: string; value: ContentBlockType }[] = [
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___titel'),
			value: ContentBlockType.Heading,
		},
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___tekst'),
		...
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___intro'),
		...
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___klaar'),
		...
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___quote'),
		...
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___hero'),
			value: ContentBlockType.Hero,
		},
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___zoek'),
		...
		{
			label: AdminConfigManager.getConfig().services.i18n.t('admin/content-block/content-block___usp'),
