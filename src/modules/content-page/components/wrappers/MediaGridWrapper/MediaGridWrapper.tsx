...
import { ContentTypeString, toEnglishContentType } from '@admin/collection/collection.types';
import ItemVideoDescription from '@admin/shared/components/ItemVideoDescription/ItemVideoDescription';
import {
	LoadingErrorLoadedComponent,
	LoadingInfo,
} from '@admin/shared/components/LoadingErrorLoadedComponent/LoadingErrorLoadedComponent';
import { isMobileWidth } from '@admin/shared/helpers/media-query';
...
const MediaGridWrapper: FunctionComponent<MediaGridWrapperProps & RouteComponentProps & UserProps> =
	({
		title,
		buttonLabel,
		buttonAltTitle,
		...
		const [resolvedResults, setResolvedResults] = useState<ResolvedItemOrCollection[] | null>(
			null
		);
